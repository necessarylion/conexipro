<template>
  <div class="flex items-center justify-center h-screen lg:px-40 md:px-10 px-0 xs:py-0 md:py-12">
    <div class="flex flex-row w-full h-full shadow rounded-lg">
      ...
      <div class="bg-background w-1/2 rounded-s-lg px-10 py-10 md:flex hidden flex-col gap-3">
        <div class="flex flex-row items-center gap-3">
          ...
          <div>
            ...
            <div class="text-whiteSecondary text-xs mb-1">
              Let's create digital profile with us!
            </div>
          </div>
        </div>
      ...
      <!-- right -->
      <div
        class="bg-white lg:w-1/2 md:w-1/2 w-full sm:rounded-none md:rounded-e-lg lg:px-20 md:px-10 px-8 py-10 flex flex-col"
      >
        <div class="right-header">
          <div class="text-black text-xl font-semibold mb-3">Conexipro.</div>
          <div class="text-grey text-xs mb-7">
            Welcome back! login with your account to continue with us
          </div>
        </div>

        <div id="firebase" class="items-center justify-center flex flex-col flex-1" />
      </div>
    </div>
  </div>
</template>
